...
import com.Matrix.DexPatcher.DexPatcher;
import com.Matrix.DexPatcher.Translation.TranslationPatcher;
import com.Matrix.crc32.crc32;
import com.Matrix.manifest.manifestP;
import com.Matrix.ui.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (inputPath.endsWith(".apk")) {
                ...
                tempDir = Files.createTempDirectory("Matrix_merge").toFile();
                Logger.log("[MERGE] Extracting APKS...");
                MatrixUtils.ex_apks(inputApk, tempDir);
